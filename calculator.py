...
# 非呼吸机品类下，合法可计算的备注白名单（其余全部置0）
VALID_REMARKS = {"", "斯达克全品类1.2倍提成", "即墨医院订单",
                 "武汉中南订单", "武汉人民订单",
                 "武汉中南转门店", "武汉人民转门店"}
...
def calc_commission_base(row):
    """严格对齐Excel公式：备注白名单校验 + 分场景计算计提基数 + AB分配叠加"""
    # 基础字段读取+空值兜底
